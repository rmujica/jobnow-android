...
public class RecyclingOffersAdapter extends RecyclerView.Adapter<OfferViewHolder> {

    List<Offer> offers = new ArrayList<Offer>(100);
    Context context;
    boolean isSlim;

    public RecyclingOffersAdapter(Context context) {
        this.context = context;
    }

    public RecyclingOffersAdapter(Context context, boolean isSlim) {
        this.context = context;
        this.isSlim = isSlim;
    }
